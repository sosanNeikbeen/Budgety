...
"use strict";
eval("\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\nvar _Input = __webpack_require__(/*! ./models/Input */ \"./src/js/models/Input.js\");\n\nvar _Input2 = _interopRequireDefault(_Input);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar state = {};\n\n//Input controller\nvar controlInput = function controlInput() {\n  state.input = new _Input2.default();\n  console.log(state.input.getInput());\n};\n\n_base.elements.inputButton.addEventListener(\"submit\", function (e) {\n  e.preventDefault();\n  controlInput();\n});\n\nconsole.log(_base.elements);\nconsole.log(\"hi\");\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Input = function () {\n  function Input() {\n    _classCallCheck(this, Input);\n  }\n\n  _createClass(Input, [{\n    key: \"getInput\",\n    value: function getInput() {\n      return {\n        type: _base.elements.inputType.value,\n        desc: _base.elements.inputDesc.value,\n        value: parseFloat(_base.elements.inputValue.value)\n      };\n    }\n  }]);\n\n  return Input;\n}();\n\nexports.default = Input;\n\n//# sourceURL=webpack:///./src/js/models/Input.js?");
